...
\newcommand\BasicInfo[6]{
    \begin{flalign*}
        &  \text{\faUser} \text{ : #1} & & \text{\faGraduationCap} \text{: #2}  &  & \text{\faCalendar} \text{ : #3}  \\
        &  \text{\faUniversity} \text{: #4} & & \text{\faCode} \text{ :  #5}  &  & \text{\faLink} \text{ : #6} 
    \end{flalign*}
    }
...
\newtcbtheorem[auto counter]{studentcomment}{\faCommentingO \; Student Comments}%
{colback=white!5,colframe=green!25!black,fonttitle=\bfseries}{def}
